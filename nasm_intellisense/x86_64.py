...
class Instruction:
    ...
    def __str__(self):
        """Returns string representation of the instruction name"""
        return self.name
...
def read_instruction_set(filename=None):
    ...
    """
    if filename is None:
        data = importlib.metadata.PathDistribution("opcodes").joinpath("x86_64.xml").open('r')
    ...
    print("|".join(str(instruction) for instruction in instruction_set))
    return instruction_set

if __name__ == "__main__":
    read_instruction_set(filename="x86_64.xml")
